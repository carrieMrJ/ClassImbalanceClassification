...
class SelfPacedEnsemble():
    ...
    base_estimator : object, optional (default=sklearn.Tree.DecisionTreeClassifier())
        The base estimator_ to fit on self-paced under-sampled subsets of the dataset.
    ...
    base_estimator_ : estimator_
        The base estimator_ from which the ensemble is grown.

    estimators_ : list of estimator_
    ...
    X_tra, X_te, y_tra, y_te = imbalance_train_test_split(
    ...
    print('auc_prc_score: {}'.format(spe.score(X_te, y_te)))
    ```
    ...
    def _fit_base_estimator(self, X, y):
        """Private function used to train a single base estimator_."""
    ...
    def fit(self, X, y, label_maj=0, label_min=1):
        ...
        X : {array-like, sparse matrix} of shape = [n_samples, n_features]
            ...
            they are supported by the base estimator_.
